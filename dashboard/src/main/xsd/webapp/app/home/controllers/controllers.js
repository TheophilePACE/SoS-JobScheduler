...
JobSchedulerApp.controller('MainController', ['$scope',
    function ($scope) {
    }]);

JobSchedulerApp.controller('AdminController', ['$scope',
    function ($scope) {
    }]);

JobSchedulerApp.controller('LanguageController', ['$scope', '$translate',
...
JobSchedulerApp.controller('MenuController', ['$scope',
    function ($scope) {
    }]);

JobSchedulerApp.controller('LoginController', ['$scope', '$location', 'AuthenticationSharedService',
...
JobSchedulerApp.controller('LogoutController', ['$location', 'AuthenticationSharedService',
...
JobSchedulerApp.controller('SettingsController', ['$scope', 'Account',
...
JobSchedulerApp.controller('PasswordController', ['$scope', 'Password',
...
JobSchedulerApp.controller('SessionsController', ['$scope', 'resolvedSessions', 'Sessions',
 ...
 JobSchedulerApp.controller('TrackerController', ['$scope',
    function ($scope) {
...
JobSchedulerApp.controller('MetricsController', ['$scope', 'MetricsService', 'HealthCheckService', 'ThreadDumpService',
...
JobSchedulerApp.controller('LogsController', ['$scope', 'resolvedLogs', 'LogsService',
...
JobSchedulerApp.controller('AuditsController', ['$scope', '$translate', '$filter', 'AuditsService',
